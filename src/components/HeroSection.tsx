...
const HeroSection: React.FC = () => {
  return (
    <div className="w-full relative pt-14 pb-24 px-6 md:px-12 lg:px-24 font-outfit">
      {/* Left leaf icon */}
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-bold mb-8 text-farmnext-black leading-tight">
          Revolutionizing Farming <br />
          with <span className="text-farmnext-green">Smart Solutions</span>
        </h1>
        
        <p className="text-gray-600 text-lg md:text-xl mx-auto max-w-3xl mb-12 leading-relaxed">
        ...
        <div className="mt-10">
          <Link 
            to="/get-started" 
            className="bg-farmnext-green hover:bg-farmnext-darkgreen text-white py-3.5 px-10 rounded-full transition-all duration-300 font-medium text-lg shadow-md hover:shadow-lg hover:scale-105 transform"
          >
            Get started
          </Link>
        </div>
